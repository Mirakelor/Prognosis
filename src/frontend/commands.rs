...
pub const COMMANDS: &[(&str, &str)] = &[
    ...
    ("history", "List past sessions and load one fully (waits for your next message)"),
    ("continue", "Resume the most recent session (waits for your next message)"),
    ("remember", "Inject an archived session summary (waits for your next message)"),
    ("resume", "Resume a session by id (/resume <id>; waits for your next message)"),
